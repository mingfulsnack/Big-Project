...
function MusicCard(props) {
    ...
    function handlePlay() {
        console.log("1");
        tmp.isSelect = props.music.id;
        dispatch({type:"selected_music",payload:tmp});
        dispatch1(setCurrentPlaying(props.music))
        dispatch1(increaseTimesPlayed(props.music.id));
    }
